...
export const SEO = {
  ...
  keywords:
    'художник, картины, галерея картин, заказ картин, картина на заказ, купить картину, живопись, масло, акварель, портрет, пейзаж, современный художник, Дарья Вичкунина',
