...
export const site: SiteContent = {
  ...
  bio: [
    ...
    'Днём пишу код, а вечером с собачулькой под боком смотрю сериалы и рисую. Рисование для меня — про то, чтобы в реальности стало больше: деталей, фантазии и смелости! Масло люблю больше всего, но беру и всё, на что глаз падает.',
  ],
